...
public:
    ...
    virtual vector<HallBroadCastReply*> buildHBCRVec() = 0 ;
    virtual vector<GameReply*>buildGRVec()=0 ;
};
...
public: 
    ...
    vector<HallBroadCastReply*> buildHBCRVec() override ; 
    vector<GameReply*>buildGRVec()override ;
    //the list operation : 
